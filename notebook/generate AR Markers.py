...
def handleArgs():
    ...
    parser.add_argument('-g', '--generate',default=6 , help='generate n random markers', type=int)
    parser.add_argument('-i', '--id', default=12,help='generate a marker with a specific id', type=int)
